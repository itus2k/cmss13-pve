/datum/game_mode/colonialmarines/ai/kitchen
	name = "Kitchen Holdout"
	config_tag = "Kitchen Holdout"
	required_players = 0
	votable = TRUE
	...
	toggleable_flags = MODE_NO_JOIN_AS_XENO|MODE_HARDCORE_PERMA|MODE_DISABLE_FS_PORTRAIT|MODE_DISABLE_JOE_RESPAWN|MODE_STRIP_NONUNIFORM_ENEMY
...
GLOBAL_LIST_INIT(platoon_to_jobs, list(/datum/squad/marine/cryo = list(
		/datum/job/command/police = JOB_POLICE,
		/datum/job/command/)
))
